...
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(s, T(0), T(0), T(0)), col_type(T(0), s, T(0), T(0)), col_type(T(0), T(0), s, T(0))}
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
...
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0], T(0), T(0)), col_type(m[1], T(0), T(0)), col_type(0, 0, 1, 0)}
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
...
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0], T(0)), col_type(m[1], T(0)), col_type(m[2], T(0))}
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
...
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0], T(0)), col_type(m[1], T(0)), col_type(0, 0, 1, 0)}
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->value[0] = col_type(m[0], 0);
...
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0], T(0), T(0)), col_type(m[1], T(0), T(0)), col_type(m[2], T(1), T(0))}
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->value[0] = col_type(m[0], 0, 0);
