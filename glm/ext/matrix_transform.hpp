...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_DECL GLM_CONSTEXPR genType identity();
    ...
    /// @see no resource...
    template <typename T, qualifier Q>
    GLM_NODISCARD GLM_FUNC_QUALIFIER mat<4, 4, T, Q> shear(
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL mat<4, 4, T, Q> lookAtRH(
	...
	/// @see - frustum(T const& left, T const& right, T const& bottom, T const& top, T const& nearVal, T const& farVal) frustum(T const& left, T const& right, T const& bottom, T const& top, T const& nearVal, T const& farVal)
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL mat<4, 4, T, Q> lookAtLH(
		vec<3, T, Q> const& eye, vec<3, T, Q> const& center, vec<3, T, Q> const& up);
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL mat<4, 4, T, Q> lookAt(
		vec<3, T, Q> const& eye, vec<3, T, Q> const& center, vec<3, T, Q> const& up);
