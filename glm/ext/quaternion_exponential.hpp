...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_DECL qua<T, Q> exp(qua<T, Q> const& q);
	...
	/// @tparam Q A value from qualifier enum
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL qua<T, Q> log(qua<T, Q> const& q);
	...
	/// @tparam Q A value from qualifier enum
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL qua<T, Q> pow(qua<T, Q> const& q, T y);
	...
	/// @tparam Q A value from qualifier enum
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL qua<T, Q> sqrt(qua<T, Q> const& q);
