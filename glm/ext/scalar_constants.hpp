...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_DECL GLM_CONSTEXPR genType epsilon();

	/// Return the pi constant for floating point types.
	template<typename genType>
	GLM_NODISCARD GLM_FUNC_DECL GLM_CONSTEXPR genType pi();

	/// Return the value of cos(1 / 2) for floating point types.
	template<typename genType>
	GLM_NODISCARD GLM_FUNC_DECL GLM_CONSTEXPR genType cos_one_over_two();
