...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_DECL T length(qua<T, Q> const& q);
	...
	/// @see ext_quaternion_geometric
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL qua<T, Q> normalize(qua<T, Q> const& q);
	...
	/// @see ext_quaternion_geometric
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL T dot(qua<T, Q> const& x, qua<T, Q> const& y);
