...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_DECL vec<L, T, Q> pow(vec<L, T, Q> const& base, vec<L, T, Q> const& exponent);
	...
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.2 Exponential Functions</a>
	template<length_t L, typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL vec<L, T, Q> exp(vec<L, T, Q> const& v);
	...
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.2 Exponential Functions</a>
	template<length_t L, typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL vec<L, T, Q> log(vec<L, T, Q> const& v);
	...
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.2 Exponential Functions</a>
	template<length_t L, typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL vec<L, T, Q> exp2(vec<L, T, Q> const& v);
	...
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.2 Exponential Functions</a>
	template<length_t L, typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL vec<L, T, Q> log2(vec<L, T, Q> const& v);
	...
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.2 Exponential Functions</a>
	template<length_t L, typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL vec<L, T, Q> sqrt(vec<L, T, Q> const& v);
	...
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.2 Exponential Functions</a>
	template<length_t L, typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL vec<L, T, Q> inversesqrt(vec<L, T, Q> const& v);
