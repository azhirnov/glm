...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_DECL void axisAngle(
		mat<4, 4, T, Q> const& Mat, vec<3, T, Q> & Axis, T & Angle);

	/// Build a matrix from axis and angle.
	/// From GLM_GTX_matrix_interpolation extension.
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL mat<4, 4, T, Q> axisAngleMatrix(
		vec<3, T, Q> const& Axis, T const Angle);

	/// Extracts the rotation part of a matrix.
	/// From GLM_GTX_matrix_interpolation extension.
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL mat<4, 4, T, Q> extractMatrixRotation(
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL mat<4, 4, T, Q> interpolate(
