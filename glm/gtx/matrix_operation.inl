...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<2, 2, T, Q> diagonal2x2
	(
		vec<2, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<2, 3, T, Q> diagonal2x3
	(
		vec<2, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<2, 4, T, Q> diagonal2x4
	(
		vec<2, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<3, 2, T, Q> diagonal3x2
	(
		vec<2, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<3, 3, T, Q> diagonal3x3
	(
		vec<3, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<3, 4, T, Q> diagonal3x4
	(
		vec<3, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<4, 4, T, Q> diagonal4x4
	(
		vec<4, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<4, 3, T, Q> diagonal4x3
	(
		vec<3, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<4, 2, T, Q> diagonal4x2
	(
		vec<2, T, Q> const& v
	)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<2, 2, T, Q> adjugate(mat<2, 2, T, Q> const& m)
	{
		return mat<2, 2, T, Q>(
			+m[1][1], -m[0][1],
			-m[1][0], +m[0][0]);
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<3, 3, T, Q> adjugate(mat<3, 3, T, Q> const& m)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER mat<4, 4, T, Q> adjugate(mat<4, 4, T, Q> const& m)
	{
