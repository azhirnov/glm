...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_DECL bool intersectRayPlane(
	...
	GLM_NODISCARD GLM_FUNC_DECL bool intersectRayTriangle(
	...
	//! From GLM_GTX_intersect extension.
	template<typename genType>
	GLM_NODISCARD GLM_FUNC_DECL bool intersectLineTriangle(
		genType const& orig, genType const& dir,
	...
	//! From GLM_GTX_intersect extension.
	template<typename genType>
	GLM_NODISCARD GLM_FUNC_DECL bool intersectRaySphere(
	...
	//! From GLM_GTX_intersect extension
	template<typename genType>
	GLM_NODISCARD GLM_FUNC_DECL bool intersectLineSphere(
